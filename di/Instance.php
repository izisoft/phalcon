...
class Instance
{
     ...
     *
     * If you do not specify a container, the method will first try `Phal::$app` followed by `Phal::$container`.
     *
     * For example,
     *
     * ```php
     ...
     * If null, the method will first try `Phal::$app` then `Phal::$container`.
    ...
    public function get($container = null)
    {
        ...
        if (Phal::$app && Phal::$app->has($this->id)) {
            return Phal::$app->get($this->id);
        }

        return Phal::$container->get($this->id);
    }
