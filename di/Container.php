 ...
 *
 * By default, [[\Phal::$container]] refers to a Container instance which is used by [[\Phal::createObject()]]
 ...
 * $container->set('izi\db\Connection', [
 *     'dsn' => '...',
 * ]);
...
class Container extends Component
{
     ...
     *
     * If the class implements [[\izi\base\Configurable]], the `$config` parameter will be passed as the last
     ...
     * $container->set('izi\mail\MailInterface', 'izi\swiftmailer\Mailer');
     *
     * // register an alias name. You can use $container->get('foo')
     * // to create an instance of Connection
     * $container->set('foo', 'izi\db\Connection');
     *
     ...
     *     return new \izi\db\Connection($config);
     * });
     * ```
     *
     ...
     *
     * ```php
     * $formatString = function($string, \izi\i18n\Formatter $formatter) {
     *    // ...
     * }
     * Phal::$container->invoke($formatString, ['string' => 'Hello World!']);
     * ```
     *
    ...
    public function resolveCallableDependencies(callable $callback, $params = [])
    {
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            if (($class = $param->getClass()) !== null) {
                ...
                } elseif (isset(Phal::$app) && Phal::$app->has($name) && ($obj = Phal::$app->get($name)) instanceof $className) {
                    $args[] = $obj;
                } else {
     ...
     *     'izi\web\Request' => 'app\components\Request',
     *     'izi\web\Response' => [
