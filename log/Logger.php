 ...
 *
 * A Logger instance can be accessed via `Phal::getLogger()`. You can call the method [[log()]] to record a single log message.
...
class Logger extends Component
{
    ...
    {
        $timings = $this->getProfiling(['izi\db\Command::query', 'izi\db\Command::execute']);
        $count = count($timings);
        $time = 0;
