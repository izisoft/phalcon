...
class Command extends Component
{
    ...
    public function execute()
    {
        ...
        try {
            $profile and Phal::beginProfile($rawSql, __METHOD__);

            $this->internalExecute($rawSql);
            $n = $this->pdoStatement->rowCount();

            $profile and Phal::endProfile($rawSql, __METHOD__);
    ...
    protected function queryInternal($method, $fetchMode = null)
    {
        ...
        if ($method !== '') {
            ...
            if (is_array($info)) {
                ...
                if (is_array($result) && isset($result[0])) {
                    Phal::debug('Query result served from cache', 'izi\db\Command::query');
                    return $result[0];
                }
            }
        }
        ...
        try {
            $profile and Phal::beginProfile($rawSql, 'izi\db\Command::query');
            ...
            $profile and Phal::endProfile($rawSql, 'izi\db\Command::query');
        } catch (Exception $e) {
            $profile and Phal::endProfile($rawSql, 'izi\db\Command::query');
            throw $e;
        }
        ...
        if (isset($cache, $cacheKey, $info)) {
            ...
            Phal::debug('Saved query result in cache', 'izi\db\Command::query');
        }
